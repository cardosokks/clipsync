// Web Audio API lightweight synthesizer for crisp, non-intrusive sound feedback
...
class SoundEffects {
  ...
  // Soft ping when mouse enters the top-right hotspot
  public playProximityHover() {
  ...
  // Pleasant chime when item is copied to clipboard
